...
def create_html_slide(slide_data):
    ...
    Inclus un espace pour une image avec l'id 'slide-image' et la classe 'slide-image'.
    L'image doit être centrée et avoir une largeur maximale de 80% de son conteneur.
    Utilise des styles CSS modernes et attrayants.
    Assure-toi que le HTML est valide et complet, incluant les balises <!DOCTYPE html>, <html>, <head>, et <body>.
    """
